/**
 * @fileoverview Closure Compiler externs for Facebook Thirdparty.ReactDOM.js DOM 0.14.0
 ...
 */
Thirdparty.ReactDOM = function() {}


/**
 * The current version of Thirdparty.ReactDOM.
 *
 * @type {string}
 * @const
 */
Thirdparty.ReactDOM.version;
 ...
 */
Thirdparty.ReactDOM.render = function(container, mountPoint, opt_callback) {};
 ...
 * @return {boolean}
 */
Thirdparty.ReactDOM.unmountComponentAtNode = function(container) {};
 ...
 * @return {Element}
 */
Thirdparty.ReactDOM.findDOMNode = function(component) {};
 ...
 */
Thirdparty.ReactDOM.unstable_batchedUpdates = function(callback, opt_a, opt_b, opt_c, opt_d, opt_e, opt_f) {};
 ...
 */
Thirdparty.ReactDOM.unstable_renderSubtreeIntoContainer = function(parentComponent, nextElement, container, opt_callback) {};

// Version 16

Thirdparty.ReactDOM.hydrate = function() {};
Thirdparty.ReactDOM.createPortal = function() {};
